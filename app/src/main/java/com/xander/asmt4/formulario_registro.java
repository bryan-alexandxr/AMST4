...
public class formulario_registro extends AppCompatActivity {
    ...
    private void addNotification() {
        if (android.os.Build.VERSION.SDK_INT >=android.os.Build.VERSION_CODES.O) {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, id).setSmallIcon(R.drawable.aa).setContentTitle("Se ha registrado con éxito").setContentText("Revise su correo electrónico en los próximos 2 días");
